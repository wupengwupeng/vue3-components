<template>
  <el-upload v-loading="loading" class="app-upload" drag action :http-request="httpRequest" :show-file-list="false"
    ...
    <el-tooltip append-to-body placement="top" :show-after="500">
      ...
      <template v-if="modelValue">
        ...
        <div v-else
          ...
          <img v-if="isPDFUrl(modelValue)" class="w-48 h-48 object-contain" src="@/assets/img/pdf.svg" alt="图片" />
          <img v-else-if="isDOCUrl(modelValue)" class="w-48 h-48 object-contain" src="@/assets/img/doc.svg" alt="图片" />

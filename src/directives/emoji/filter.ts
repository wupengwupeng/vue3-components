 ...
 * @returns {number}: 光标位置
 */
function getCursorPos(elObject: any) {
  let CaretPos = 0;
  // IE Support 
 ...
 * @param pos: 光标位置
 */
function setCursorPos(elObject: any, pos: any) {
 ...
 * @param text
 */
const replaceAndSetPos = function (elObject: any, pattern: any, text: any) {
  ...
  */
  ...
  let max_length: any = elObject.getAttribute && elObject.getAttribute('maxlength') ? parseInt(elObject.getAttribute('maxlength')) : '';
